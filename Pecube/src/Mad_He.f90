      subroutine Mad_He (time,temperature,ntime,Apatite_age,iflag,grainsize,D0,Eat)
...
!      Ea=36.2e3*4.184
      ...
      if (iflag.eq.1) then
! He in Ap
      D0a2=(D0/0.01**2)*3600.*24.*365.25e6*(100./grainsize)**2
      Ea= Eat*1e3
      elseif (iflag.eq.2) then
! He in Zi
      
      D0a2= (D0/0.01**2)*3600.*24.*365.25e6
      Ea= Eat*1e3
      elseif (iflag.eq.3) then
! Ar in Ks
      D0a2=(D0/0.05**2)*3600.*24.*365.25e6
      Ea= Eat*1e3

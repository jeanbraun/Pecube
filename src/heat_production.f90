double precision function heat_production (x0,y0,z0,temp,time,heatproduction,D_heat)
...
double precision x0,y0,z0,temp,time,heatproduction,D_heat

heat_production=heatproduction*exp(z0/(-D_heat))
